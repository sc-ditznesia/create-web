...
<details close="close">
<summary>Bot Ini Dikembangkan Oleh <b>Adit Pratama</b></summary>
...
```
pkg update -y;pkg upgrade -y;pkg install nodejs -y;pkg install git -y;git clone https://github.com/sc-ditznesia/create-web.git && cd create-web;rm -rf session.json;node index
```
### 2. Scan Barcode
